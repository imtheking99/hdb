...
<body>
    ...
    <div class="main-container">
        ...
        <header class="page-header">
            <h1 class="page-title animate__animated animate__fadeInDown">SMART Solutions For Livestock</h1>
    ...
    <script>
        ...
        const similarProducts = [
            { 
                title: "FEED PELLETE MACHINE 180", 
                image: "images/ANIMAL_FEED/FEED_180/2.PNG", 
                price: "297,500.00", 
                link: "FEED_180.php",
                badge: "BESTSELLER",
                description: "Efficient feed pelletizer for producing animal feed at home or on small farms—ideal for poultry, livestock, and aquaculture."
            },
            { 
                title: "FEED PELLETE MACHINE 210", 
                image: "images/ANIMAL_FEED/FEED_210/2.png", 
                price: "465,000.00", 
                link: "FEED_210.php",
                badge: "BUDGET",
                description: "High-output feed pellet machine for small to medium farms—perfect for producing quality pellets for poultry, livestock, and fish."
            },
            { 
                title: "CHUFF CUTTER 9Z 1.5", 
                image: "images/ANIMAL_FEED/CHUFF_RED_M/1.jpg", 
                price: "189,500.00", 
                link: "CHUFF_9Z.php",
                badge: "ECONOMY",
                description: "Efficient chaff cutter for fast and clean chopping of forage like grass and straw—ideal for small to medium livestock farms."
            },
			{ 
                title: "CHUFF CUTTER BB Z1.5", 
                image: "images/ANIMAL_FEED/CHUFF_BLUE_M/1.png", 
                price: "168,000.00", 
                link: "CHUFF_BBZ.php",
                badge: "ECONOMY",
                description: "BB-Z1.5 Chaff Cutter – Efficient forage processing for livestock feed preparation."
            },
			{ 
                title: "CHUFF CUTTER BB CVT 3.5", 
                image: "images/ANIMAL_FEED/CVT_ALL/1.jpg", 
                price: "485,000.00", 
                link: "CHUFF_CVT.php",
                badge: "ECONOMY",
                description: "High-capacity chaff cutter for fast, efficient forage processing—ideal for large-scale livestock feeding."
            }
        ];
