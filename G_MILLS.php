...
<body>
    ...
    <div class="main-container">
        ...
        <header class="page-header">
            <h1 class="page-title animate__animated animate__fadeInDown">Premium Grinding Mills</h1>
    ...
    <script>
        ...
        const similarProducts = [
            { 
                title: "9FC 2021 GRINDING MILL", 
                image: "images/G_MILLS/9FC_2021_G_MILL/2.jpg", 
                price: "169,000.00", 
                link: "9FC_2021_G_MILL.php",
                badge: "BESTSELLER",
                description: "All-in-one grinding solution designed for maximum efficiency and high-performance processing."
            },
            { 
                title: "ULTARFINE GRINDING MILL", 
                image: "images/G_MILLS/ULTRAFINE_G_MILL/2.jpg", 
                price: "189,500.00", 
                link: "ULTRAFINE_G_MILL.php",
                badge: "FINER POWDER",
                description: "All-in-one grinding solution engineered for maximum efficiency and ultra-fine powder output."
            },
            { 
                title: "FULLY SS GRINDING MILL", 
                image: "images/G_MILLS/FULLYSS_G_MILL/6.jpg", 
                price: "259,000.00", 
                link: "FULLYSS_G_MILL.php",
                badge: "STAINLESS STEEL BODY",
                description: "All-in-one grinding solution with a durable full stainless steel body, delivering maximum efficiency and ultra-fine powder results."
            }
        ];
