...
<body>
    ...
    <div class="main-container">
        ...
        <header class="page-header">
            <h1 class="page-title animate__animated animate__fadeInDown">Premium Rice Mills</h1>
    ...
    <script>
        ...
        const similarProducts = [
            { 
                ...
                link: "FEED_180.php",
                badge: "BESTSELLER",
                description: "All-in-one rice processing solution with 5 functions for maximum efficiency"
            },
            { 
                title: "FEED PELLETE MACHINE 180", 
                ...
                link: "FEED_210.php",
                badge: "BUDGET",
                description: "All-in-one rice processing solution with 4 functions for maximum efficiency"
            },
            { 
                ...
                link: "CHUFF_9Z.php",
                badge: "ECONOMY",
                description: "Compact and efficient rice mill perfect for small to medium scale operations"
            },
			{ 
